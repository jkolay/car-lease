...
public class CustomExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  protected ResponseEntity<Object> handleMethodArgumentNotValid(
    ...
    final LeaseRequestErrorModel error =
        new LeaseRequestErrorModel(
            errors, CarLeaseErrorCodeConfig.INVALID_INPUT, ErrorSeverityLevelCodeType.ERROR);
  ...
  public ResponseEntity<Object> handleCustomerNotFoundException(CustomerNotFoundException ex) {
    final LeaseErrorModel error =
        new LeaseErrorModel(
            ex.getMessage(),
            CarLeaseErrorCodeConfig.INVALID_INPUT,
  ...
  public ResponseEntity<Object> handleDataIntegrityViolationException(
    ...
    final LeaseErrorModel error =
        new LeaseErrorModel(
            message, CarLeaseErrorCodeConfig.DB_ERROR, ErrorSeverityLevelCodeType.ERROR);
  ...
  public final ResponseEntity<Object> handleConstraintViolation(ConstraintViolationException ex) {
    final LeaseErrorModel error =
        new LeaseErrorModel(
            ex.getMessage(), CarLeaseErrorCodeConfig.DB_ERROR, ErrorSeverityLevelCodeType.ERROR);
    return new ResponseEntity<>(error, HttpStatus.BAD_REQUEST);
  }
  ...
  public ResponseEntity<Object> handleRuntimeException(RuntimeException ex) {
    final LeaseErrorModel error =
        new LeaseErrorModel(
            ex.getMessage(),
            CarLeaseErrorCodeConfig.INTERNAL_ERROR,
            ErrorSeverityLevelCodeType.ERROR);
  ...
  public ResponseEntity<Object> handleGlobalException(Exception ex) {
    final LeaseErrorModel error =
        new LeaseErrorModel(
            ex.getMessage(),
            CarLeaseErrorCodeConfig.GLOBAL_ERROR,
            ErrorSeverityLevelCodeType.ERROR);
    return new ResponseEntity<>(error, HttpStatus.BAD_REQUEST);
  }
}
